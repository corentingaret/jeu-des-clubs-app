...
class Player(db.Model):
    ...
    country_born = db.relationship('Country', foreign_keys=[id_country_born], backref='born_players')
    country_nationality = db.relationship('Country', foreign_keys=[id_country_nationality], backref='national_players')
...
class Match(db.Model):
    ...
    home_club = db.relationship('Club', foreign_keys=[id_home_club], backref='home_matches')
    away_club = db.relationship('Club', foreign_keys=[id_away_club], backref='away_matches')
...
class Transfer(db.Model):
    ...
    from_club = db.relationship('Club', foreign_keys=[id_from_club], backref='transfers_from')
